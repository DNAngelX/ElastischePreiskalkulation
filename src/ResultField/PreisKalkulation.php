...
namespace ElasticExportPreisKalkulation\ResultField;
 ...
 * Class RakutenDE
 */
class PreisKalkulation extends ResultFields
{
    const SHOP = 1.00;
    /*
     * @var ArrayHelper
    ...
    public function generateResultFields(array $formatSettings = []):array
    {
        ...
        $reference = $settings->get('referrerId') ? $settings->get('referrerId') : self::SHOP;
